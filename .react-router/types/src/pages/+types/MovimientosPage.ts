...
type Module = typeof import("../MovimientosPage.js")

type Info = GetInfo<{
  file: "pages/MovimientosPage.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../../routes/ProtectedRoute.js");
}, {
  id: "layouts/DashboardLayout";
  module: typeof import("../../layouts/DashboardLayout.js");
}, {
  id: "pages/MovimientosPage";
  module: typeof import("../MovimientosPage.js");
}];
